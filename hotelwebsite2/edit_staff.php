...
<?php
         ...
         if(mysqli_num_rows($result) == 1) {
            ...
            <p style="color: white" align="center"><label class = "label" for = "phone_num"> Phone Num : </label><br>
            ...
            <p style="color: white" align="center"><label class = "label" for = "password"> Password: </label><br>
